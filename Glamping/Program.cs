...
try
{
    ...
    string? Formapago1 = Console.ReadLine();  // Lee el tipo de pago desde la consola
    Console.WriteLine("\n");
   ...
   var Cliente4 = new Precios()
    ...
    Console.WriteLine(Cliente4);  // Imprime la información del cliente y la reserva

    var Cliente5 = new Precios()
    {
        Nombre = "Aaron",
        Apellido = "Gómez",
        Correo = "renny62@gmail.com",
